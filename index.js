...
var payment_url = {
    'prod': 'https://merchant.grezpay.com/crm/jsp/paymentrequest',
...
module.exports = {
    headers: {
        'authorization': 'YOUR-AUTHORIZATION-HEADER' // will be provided by grezpay
    },

    credentails: {
        'pay_id': 'YOUR-MERCHANT-KEY', // will be provided by grezpay
        'salt': 'YOUR-SALT-KEY', // will be provided by grezpay
    },
    ...
    getPaymentUrl: function() {
        if (this.mode == 'prod') {
            return 'https://merchant.grezpay.com/crm/jsp/paymentrequest';
        } else {
            return 'https://uat.grezpay.com/crm/jsp/paymentrequest';
        }
    },
